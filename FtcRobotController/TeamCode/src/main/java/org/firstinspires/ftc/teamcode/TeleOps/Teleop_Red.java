...
public class Teleop_Red extends OpMode {
    ...
    // Telemetry telemetry;
    public static Pose startingPose = new Pose(84.64,80.09,0.87045);
    ...
    public Pose Push = new Pose(127,66, Math.toRadians(90));
    public Pose Departe = new Pose(84.34,19.13,1.1941);
    private Pose Aproape = new Pose(84.64,80.09,0.87045);
    ...
    public void loop() {
        ...
        if(gamepad1.leftStickButtonWasPressed()){
            outtake.motor_shooter_1.setVelocity(1370);
            outtake.motor_shooter_2.setVelocity(1370);
        }
